    ...
    class GoogleEarthWebBrowser : WebBrowser
    {
        ...
        public string loadGE()
        {
            ...
            using (HtmlTextWriter writer = new HtmlTextWriter(stringWriter))
            {
                ...
                writer.WriteLine("\tfunction finished(kmlObject) {");
                writer.WriteLine("\t\tif (!kmlObject) {");
                ...
                writer.WriteLine();
                writer.WriteLine("\t\tge.getFeatures().appendChild(kmlObject);");
                // if KML file has a LookAt or Camera element, assign it as the plugin's view
                writer.WriteLine("\t\tif (kmlObject.getAbstractView())");
                writer.WriteLine("\t\t\tge.getView().setAbstractView(kmlObject.getAbstractView());");
